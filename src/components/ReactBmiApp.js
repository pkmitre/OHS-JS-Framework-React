...
var ReactBmiApp = React.createClass({
  ...
  componentWillMount: function() {
    FHIR.patients((patients) => this.setState({ patients: patients }));
  },
      ...
      <div className="container">
        <nav className="navbar navbar-light bg-faded">
          ...
          <ul className="nav nav-pills">
            <li className={homeClass}><Link className="nav-link" to="/">Home</Link></li>
            <li className={aboutClass}><Link className="nav-link" to="about">About</Link></li>
          </ul>
        </nav>
        <RouteHandler patients={this.state.patients}/>
      </div>
    );
  }
